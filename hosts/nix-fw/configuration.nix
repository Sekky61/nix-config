{
  ...
  # Increase limits
  boot.kernel.sysctl = {
    "fs.inotify.max_user_watches" = 1348576; # default: 8192
    ...
    greetd = {
      ...
      settings = {
        default_session = {
          ...
          command = ''${pkgs.tuigreet}/bin/tuigreet --greeting 'The royal PC is clean, your Highness' --user-menu --asterisks --time --remember --cmd "start-hyprland -- --config /home/michal/.config/hypr/config/hyprland.lua" --kb-command 1 --kb-sessions 2 --kb-power 3'';
          user = "greeter";
        };
      };
    };
