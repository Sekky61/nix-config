...
M.globalkeys = gears.table.join(
    ...
    awful.key({ }, "XF86AudioRaiseVolume", function () awful.util.spawn("amixer -D default sset Master '5%+'") end),
    awful.key({ }, "XF86AudioLowerVolume", function () awful.util.spawn("amixer -D default sset Master '5%-'") end),
    awful.key({ }, "XF86AudioMute", function () awful.util.spawn("amixer -D default sset Master '0%'") end),
